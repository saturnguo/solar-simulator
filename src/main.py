...
sun = Body("sun", 1.98892e30, 0, 0, 0, 0, 32, 255, 200, 0)
mercury = Body("mercury", 0.33e24, -65.9e9, 0, 0, 47890, 4, 133, 132, 145)
venus = Body("venus", 4.87e24, -108.2e9, 0, 0, 35040, 5.5, 240, 200, 180)
earth = Body("earth", 5.97e24, -149.6e9, 0, 0, 29790, 6, 40, 100, 180)
mars = Body("mars", 0.642e24, -227.9e9, 0, 0, 24140, 4, 210, 80, 40)
jupiter = Body("jupiter", 1898e24, -778.5e9, 0, 0, 13140, 12, 200, 170, 100)
saturn = Body("saturn", 568e24, -1432.0e9, 0, 0, 9710, 11, 210, 180, 140)
